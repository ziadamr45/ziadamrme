export const projects = [
  {
    ...
    tech: ["Next.js", "React", "TypeScript", "Tailwind CSS", "PostgreSQL", "Prisma", "NextAuth", "PWA", "shadcn/ui", "Radix UI", "Framer Motion", "Zustand", "Recharts", "React Hook Form", "Zod", "dnd-kit", "Sonner", "Embla Carousel", "Lucide", "Web Push API", "Vercel", "Git", "Node.js", "Bun", "next-intl", "next-themes", "React Query", "Sharp", "cmdk", "date-fns", "TanStack Table", "MDX Editor", "React Markdown", "ESLint"],
  ...
  },
  {
    ...
    tech: ["Next.js", "React", "TypeScript", "Tailwind CSS", "LiveKit", "Prisma", "NextAuth", "Socket.io", "shadcn/ui", "Radix UI", "Framer Motion", "Zustand", "Recharts", "React Hook Form", "Zod", "dnd-kit", "Sonner", "Embla Carousel", "Lucide", "Vercel", "Git", "Node.js", "Bun", "next-intl", "next-themes", "React Query", "Sharp", "cmdk", "date-fns", "TanStack Table", "MDX Editor", "React Markdown", "Ably", "ESLint"],
  ...
  },
  {
    ...
    tech: ["Next.js", "React", "TypeScript", "Socket.io", "Tailwind CSS", "Prisma", "NextAuth", "Docker", "LiveKit", "shadcn/ui", "Radix UI", "Framer Motion", "Zustand", "Recharts", "React Hook Form", "Zod", "dnd-kit", "Sonner", "Embla Carousel", "Lucide", "Railway", "Vercel", "Git", "Node.js", "Bun", "next-intl", "next-themes", "React Query", "Sharp", "cmdk", "date-fns", "TanStack Table", "MDX Editor", "React Markdown", "ESLint"],
    url: "https://ma3raka.vercel.app/",
  ...
  },
  {
    ...
    tech: ["Next.js", "React", "TypeScript", "Tailwind CSS", "Prisma", "NextAuth", "LiveKit", "shadcn/ui", "Radix UI", "Framer Motion", "Zustand", "Recharts", "React Hook Form", "Zod", "dnd-kit", "Sonner", "Embla Carousel", "Lucide", "Vercel", "Git", "Node.js", "Bun", "next-intl", "next-themes", "React Query", "Sharp", "cmdk", "date-fns", "TanStack Table", "MDX Editor", "React Markdown", "Ably", "ESLint"],
  ...
  },
  {
    ...
    tech: ["Next.js", "React", "TypeScript", "Tailwind CSS", "Prisma", "NextAuth", "shadcn/ui", "Radix UI", "Framer Motion", "Zustand", "Recharts", "React Hook Form", "Zod", "dnd-kit", "Sonner", "Embla Carousel", "Lucide", "Web Push API", "Vercel", "Git", "Node.js", "Bun", "next-intl", "next-themes", "React Query", "Sharp", "cmdk", "date-fns", "TanStack Table", "MDX Editor", "React Markdown", "ESLint"],
  ...
  },
  {
    ...
    tech: ["Next.js", "React", "TypeScript", "Tailwind CSS", "Prisma", "NextAuth", "shadcn/ui", "Radix UI", "Framer Motion", "Zustand", "Recharts", "React Hook Form", "Zod", "dnd-kit", "Sonner", "Embla Carousel", "Lucide", "Vercel", "Git", "Node.js", "Bun", "next-intl", "next-themes", "React Query", "Sharp", "cmdk", "date-fns", "TanStack Table", "MDX Editor", "React Markdown", "ESLint"],
  ...
  },
  {
    ...
    tech: ["Next.js", "React", "TypeScript", "Tailwind CSS", "Prisma", "NextAuth", "Framer Motion", "shadcn/ui", "Radix UI", "Zustand", "Recharts", "React Hook Form", "Zod", "dnd-kit", "Sonner", "Embla Carousel", "Lucide", "ytdl-core", "Vercel", "Git", "Node.js", "Bun", "next-intl", "next-themes", "React Query", "Sharp", "cmdk", "date-fns", "TanStack Table", "MDX Editor", "React Markdown", "ESLint"],
  ...
  },
  {
    ...
    tech: ["Next.js", "React", "TypeScript", "Tailwind CSS", "Prisma", "NextAuth", "shadcn/ui", "Radix UI", "Framer Motion", "Zustand", "Recharts", "React Hook Form", "Zod", "dnd-kit", "Sonner", "Embla Carousel", "Lucide", "Vercel", "Git", "Node.js", "Bun", "next-intl", "next-themes", "React Query", "Sharp", "cmdk", "date-fns", "TanStack Table", "MDX Editor", "React Markdown", "Remotion", "ESLint"],
  ...
  },
  {
    ...
    tech: ["Next.js", "React", "TypeScript", "Tailwind CSS", "Prisma", "NextAuth", "Framer Motion", "PWA", "shadcn/ui", "Radix UI", "Zustand", "Recharts", "React Hook Form", "Zod", "dnd-kit", "Sonner", "Embla Carousel", "Lucide", "Vercel", "Git", "Node.js", "Bun", "next-intl", "next-themes", "React Query", "Sharp", "cmdk", "date-fns", "TanStack Table", "MDX Editor", "React Markdown", "Leaflet", "ESLint"],
  ...
  },
  {
    ...
    tech: ["Next.js", "React", "TypeScript", "Tailwind CSS", "Prisma", "NextAuth", "shadcn/ui", "Radix UI", "Framer Motion", "Zustand", "Recharts", "React Hook Form", "Zod", "dnd-kit", "Sonner", "Embla Carousel", "Lucide", "Nodemailer", "Web Push API", "Vercel", "Git", "Node.js", "Bun", "next-intl", "next-themes", "React Query", "Sharp", "cmdk", "date-fns", "TanStack Table", "MDX Editor", "React Markdown", "jsPDF", "ESLint"],
  ...
  },
  {
    ...
    details: {
      ...
      en: {
        ...
        howItWorks: "The app relies on HTML5, CSS3, and JavaScript without external frameworks, ensuring lightweight and fast loading. Firebase is used for authentication and cloud data storage via Firestore. Service Worker provides PWA support for offline functionality and push notifications. The interface uses CSS Variables for easy theme switching with localStorage for saving preferences locally.",
      },
    },
  },
  {
    ...
    tech: ["HTML5", "CSS3", "JavaScript", "Canvas API", "PWA", "Service Worker", "Google Fonts"],
    ...
    details: {
      ar: {
        ...
        features: [
          ...
          "نظام قصة تفاعلية مع 5 فصول تُفتح تدريجيًا مع تقدم اللاعب",
        ...
        challenges: "أكبر تحدٍّ كان بناء محرك لعبة كامل في ملف HTML5 واحد مع أداء سلس على جميع الأجهزة. تنفيذ نظام التصادمات مع 4 أنواع عوائق مختلفة والمطاردات الديناميكية تطلب تحسينًا مستمرًا للأداء. كذلك كان تحقيق التوازن في صعوبة اللعبة مع نظام الصعوبة الديناميكي تحديًا حقيقيًا.",
      ...
      en: {
        ...
        challenges: "The biggest challenge was building a complete game engine in a single HTML5 file while maintaining smooth performance on all devices. Implementing the collision system with 4 different obstacle types and dynamic chasers required continuous performance optimization. Balancing game difficulty with the dynamic difficulty system was also a real challenge.",
