export const translations = {
  ar: {
    ...
    latestPostsSubtitle: "آخر المنشورات على وسائل التواصل الاجتماعي",
    unableToLoad: "غير متاح حاليًا",
    viewOnPlatform: "عرض على المنصة",
    socialFeedTitle: "المنشورات",
    socialFeedSubtitle: "آخر المنشورات ووسائل التواصل",
  ...
  en: {
    ...
    latestPostsSubtitle: "Latest posts on social media",
    unableToLoad: "Currently unavailable",
    viewOnPlatform: "View on platform",
    socialFeedTitle: "Social Feed",
    socialFeedSubtitle: "Latest posts and social profiles",
